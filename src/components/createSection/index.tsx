...
import { ArtSelector } from '@/pages/auctionCreate/artSelector';
import { mintNFT } from '@/helper';
import { SafetyDepositDraft } from '@/helper/createAuctionManager';
...
export const ArtCreateView = () => {
  ...
  const gotoStep = useCallback(
    (_step: number) => {
      history(`/art/create/${_step.toString()}`);
  ...
  if (props.alert) {
    ...
    return (
      <>
        ...
        <p>{props.alert}</p>
        <Button onClick={() => history('/art/create')}>
          Back to Create NFT
        </Button>
      </>
    );
    ...
    <>
      ...
      <div className="congrats-button-container">
        ...
        <Button
          className="metaplex-button"
          onClick={() =>
            history(`/art/${props.nft?.metadataAccount.toString()}`)
          }
        >
        ...
        <Button
          className="metaplex-button"
          onClick={() => history('/auction/create')}
        >
